...
Usage (from anywhere):
    python /home/b085164/PDM_Romain_Defferrard/ESO-PDM/navtools_PDM/generate_georef_batch.py
"""
...
CONFIGS_DIR = REPO_ROOT / "navtools_PDM/PDM_configs"
OUTPUT_DIR  = REPO_ROOT / "navtools_PDM/configs_georef"
...
def generate_config(base_cfg: dict, outage_id: int, method: str, traj_path: str) -> dict:
    ...
    # root_out_dir / scenario_name -> .../georef_ALL_traj_outage_X/georef_F2B/
...
def main():
    ...
    # Shell script — written in configs_georef/
    ...
    lines = [
        ...
        f'LOG_DIR="{BASE_DIR}/logs/georef_batch"',
        'mkdir -p "${LOG_DIR}"',
